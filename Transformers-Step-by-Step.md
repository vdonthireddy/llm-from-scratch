...
![Our entire dataset containing only three sentences](./images/1.png)
...
![vocab_size formula where N is total number of words](./images/2.png)

In order to find N, we need to break our dataset into individual words.

![calculating variable **N**](./images/3.png)
...
![finding vocab size](./images/4.png)
...
![encoding our unique words](./images/5.png)
...
![Input sentence for transformer](./images/6.png)
...
![Original Paper uses 512 dimension vector](./images/7.png)
...
![Embedding vectors of our input](./images/8.png)
...
![Positional Embedding formula](./images/9.png)
...
![Positional Embedding for word: **When**](./images/10.png)

Similarly, we can calculate positional embedding for all the words in our input sentence.

![Calculating Positional Embeddings of our input **(The calculated values are rounded)**](./images/11.png)
...
![concatenation step](./images/12.png)
...
![Single Head attention in Transformer](./images/13.png)
...
![calculating Query matrix](./images/14.png)
...
![Applying softmax on resultant matrix](./images/19.png)

Doing the final multiplication step to obtain the resultant matrix from single-head attention.

![calculating the final matrix of single head attention](./images/20.png)
...
![Multi Head attention in Transformer](./images/21.png)
...
![Single Head attention vs Multi Head attention](./images/22.png)
...
![normalizing single head attention matrix](./images/23.png)
...
![Output matrix of multi head attention](./images/24.png)
...
![Feed Forward network comparison](./images/28.png)
...
![Add and Norm after Feed Forward Network](./images/31.png)
...
![Upcoming steps illustration](./images/32.png)
...
![Visualization is from [**Batool Haider](https://www.youtube.com/watch?v=gJ9kaJsE78k&t=596s)**](./images/33.gif)
...
![input comparison of encoder and decoder](./images/34.png)
...
![Decoder input **<start> **word](./images/35.png)
...
![Calculating Decoder](./images/36.png)
...
![inpur matrix for masked multi head attentions](./images/37.png)
...
![Mask Multi Head Attention (**Two Heads**)](./images/38.png)
...
![Add and Norm output of decoder](./images/39.png)
...
![flattened the last add and norm block matrix](./images/40.png)
...
![Calculating Logits](./images/41.png)
...
![Finding the Predicted word](./images/42.png)

So based on our calculations, the predicted word from the decoder is you.

![Final output of decoder](./images/43.png)
